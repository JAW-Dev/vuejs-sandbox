<template>
  <card-link
    ...
    :theHref="article[options.image.link.source]"
    :renderLink="renderElement(options.image.link.showLink)">
    <picture
      :id="options.image.wrapper.ID"
      :class="options.image.wrapper.classes"
      v-bind="options.image.wrapper.attributes"
      v-if="article[options.image.source] && options.image.showImage"
      slot="content">
      <img
        :id="options.image.ID"
        :class="options.image.classes"
        v-bind="options.image.attributes"
        :src="article[options.image.source]"
